      ...
      <div className="max-w-6xl mx-auto">
        <div className="rounded-3xl border border-border bg-gradient-to-br from-card to-background p-8 md:p-14 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 relative">
            <div>
              <p className="text-xs font-semibold tracking-[0.2em] text-cta uppercase mb-3">
                Vamos Conversar
              </p>
              ...
              <p className="text-muted-foreground mb-8">
                Conte sua necessidade. Em até 24h um especialista da RESTECH retorna com um
                diagnóstico gratuito.
              </p>

              <div className="space-y-4">
                <a
                  href="https://wa.me/5598981549151"
                  className="flex items-center gap-3 text-foreground/90 hover:text-primary transition"
                >
                  <MessageCircle size={18} className="text-primary" />
                  <span className="text-sm">(98) 98154-9151</span>
                </a>
                <a
                  href="mailto:emailrestech@gmail.com"
                  className="flex items-center gap-3 text-foreground/90 hover:text-primary transition"
                >
            ...
            <form onSubmit={onSubmit} className="glass rounded-2xl p-6 md:p-8 space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-12 rounded-md bg-cta text-cta-foreground font-semibold inline-flex items-center justify-center gap-2 hover:opacity-95 transition glow-cta disabled:opacity-60 cursor-pointer"
              >
                {loading ? (
                  "Enviando..."
                ) : (
